#!/usr/bin/env python3
"""
Corrected test suite with proper task names
"""
...
def run_corrected_test_suite():
    """Run corrected test suite with proper task names"""
    
    print("🧪 CORRECTED TEST SUITE - PROPER TASK NAMES")
    print("=" * 60)
    
    # Test configurations with CORRECT task names
    tests = [
        # Task: animate-14B (correct name)
        {
            "name": "Animate-14B Task - Small Size",
            "task": "animate-14B",
        ...
        {
            "name": "Animate-14B Task - Medium Size", 
            "task": "animate-14B",
            "prompt": "a simple red circle",
            "size": "832*480",
            "steps": 5
        ...
        # Task: s2v-14B (correct name)
        {
            "name": "S2V-14B Task - Small",
            "task": "s2v-14B",
            "prompt": "hello world",
            "size": "512*512", 
            "steps": 5
        ...
        # Task: t2v-A14B (correct name)
        {
            "name": "T2V-A14B Task - Small",
            "task": "t2v-A14B",
            "prompt": "a simple red circle",
            "size": "512*512",
            "steps": 5
    ...
    for i, test in enumerate(tests, 1):
        ...
        # Monitor job
        result = monitor_job(job_id, max_wait_minutes=5)  # 5 min timeout per test
